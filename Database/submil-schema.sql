...
--
-- Stored procedure for updating a user's data
--
...
--
-- Trigger for updating the victory register of a player
--

DELIMITER //

CREATE TRIGGER UpdateWinnerRecord
...
--
-- Event for retreieving a weekly report on player activity
--

DELIMITER //

CREATE EVENT WeeklyActivityReport
ON SCHEDULE EVERY 1 WEEK
DO
BEGIN
    INSERT INTO Activity_Report (Report_Date, Total_Players, Total_Matches)
    SELECT CURRENT_TIMESTAMP, COUNT(DISTINCT Player_ID), COUNT(Match_ID)
    FROM Player, Match_;
END //
